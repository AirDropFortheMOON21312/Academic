...
const LoadingOverlay: React.FC<{ messages: string[] }> = ({ messages }) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-md z-[70] flex flex-col items-center justify-center animate-fade-in">
...
const App: React.FC = () => {
  ...
  }, [activeTab, activeUnitId, isLoading]);
  ...
  return (
    <div className="flex h-screen w-full bg-slate-50 text-slate-900 font-sans overflow-hidden">
      ...
      <main className="flex-1 h-full overflow-hidden flex flex-col relative w-full bg-slate-50/50">
        ...
        <div ref={scrollContainerRef} className="flex-1 overflow-y-auto custom-scrollbar p-4 md:p-8 scroll-smooth">
          {activeUnitId ? (
            activeUnit?.data ? (
              renderContent()
            ) : (
